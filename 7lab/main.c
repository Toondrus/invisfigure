...
void DrawPrism(const int n)
{
    ...
    // Коэффициент для уменьшения радиуса верхнего основания
    float radiusCoefficient = 0.5;
    ...
    for (int i = 0; i < n; i++) {
        ...
        vertieces[6*i + 0] = c * radiusCoefficient;
        vertieces[6*i + 1] = s * radiusCoefficient;
        vertieces[6*i + 2] = 1.0;
